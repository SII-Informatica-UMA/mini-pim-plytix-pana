...
import es.uma.informatica.sii.plytix.pana.services.PlanService;
...
public class PlanController {
    ...
    public ResponseEntity<List<Plan>> listarPlanes(
        ...
        List<Plan> planes = planService.buscarPlanes(idPlan, nombre);
    ...
    public ResponseEntity<String> eliminarPlan(@PathVariable("idPlan") Long idPlan) {
        ...
        try {
            ...
            // Si no se encontró el plan, 404 Not Found
            return ResponseEntity
                    .status(HttpStatus.NOT_FOUND)
                    .body("Plan no encontrado (404).");
